...
async function crearCliente(){
 ...
 async function actualizarCliente() {
    ...
    const clienteActualizado = {
        ...
        activo: document.getElementById("updateActivo").value.toLowerCase() === 'true'  
        //activo: document.getElementById("updateActivo").checked
    ...
    try {
      ...
      const data = await respuesta.json();
      document.getElementById("updateResult").innerHTML = "Cliente actualizado correctamente: " + JSON.stringify(data);
    } catch (error) {
        document.getElementById("updateResult").innerHTML = "Error al actualizar cliente: " + error.message;
    }
}
